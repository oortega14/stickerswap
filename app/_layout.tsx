...
export default function RootLayout() {
  ...
  const [onboardedIntro, setOnboardedIntro] = useState<boolean | null>(null);
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <QueryClientProvider client={queryClient}>
        ...
        <AuthGate onboardedIntro={onboardedIntro}>
          <Stack
            screenOptions={{
              headerShown: false,
